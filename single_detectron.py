...
image_path = "water_bottle/water_bottle_crop_0.jpg" # Insert image path here
...
# Save outputs
path_obj = image_path.split(".")[0].split("/")[1]
output_path = f"{path_obj}/output_{path_obj}.jpg"
output_path = "water_bottle/water_bottle_output.jpg"
